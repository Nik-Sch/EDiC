...
################################################################
# This is a generated script based on design: memory_bd_inst_0
#
...
# source memory_bd_inst_0_script.tcl
...
set design_name memory_bd_inst_0
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /home/niklas/dev/8bitCpu/vivado/8bitCPU.srcs/sources_1/bd/memory_bd/memory_bd.bd $design_name
...
proc create_root_design { parentCell } {
  ...
  set i_ctrlMemInstrImmToRam [ create_bd_port -dir I i_ctrlMemInstrImmToRam ]
  set i_ctrlMemMar0NWE [ create_bd_port -dir I i_ctrlMemMar0NWE ]
  set i_ctrlMemMar1NWE [ create_bd_port -dir I i_ctrlMemMar1NWE ]
  set i_ctrlPCIncrN [ create_bd_port -dir I i_ctrlPCIncrN ]
  ...
  set io_bus [ create_bd_port -dir IO -from 7 -to 0 -type data io_bus ]
  ...
  connect_bd_net -net Net [get_bd_ports io_bus] [get_bd_pins memory/io_bus]
  connect_bd_net -net i_clk_0_1 [get_bd_ports i_clk] [get_bd_pins instrRom/clka] [get_bd_pins memory/i_clk] [get_bd_pins ram/clka]
  ...
  connect_bd_net -net i_ctrlMemInstrImmToRam_0_1 [get_bd_ports i_ctrlMemInstrImmToRam] [get_bd_pins memory/i_ctrlMemInstrImmToRam]
  ...
  connect_bd_net -net i_ctrlPCIncrN_0_1 [get_bd_ports i_ctrlPCIncrN] [get_bd_pins memory/i_ctrlPCIncrN]
  ...
  connect_bd_net -net memory_0_o_ramAddress [get_bd_pins memory/o_ramAddress] [get_bd_pins ram/addra]
  connect_bd_net -net memory_0_o_ramData [get_bd_pins memory/o_ramData] [get_bd_pins ram/dina]
  connect_bd_net -net memory_0_o_ramWE [get_bd_pins memory/o_ramWE] [get_bd_pins ram/wea]
