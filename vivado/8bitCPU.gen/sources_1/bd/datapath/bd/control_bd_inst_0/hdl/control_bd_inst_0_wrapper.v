...
//Command     : generate_target control_bd_inst_0_wrapper.bd
//Design      : control_bd_inst_0_wrapper
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module control_bd_inst_0_wrapper
   (i_clk,
    i_flagNZero,
    i_flagNegative,
    i_instrCode,
  ...
  control_bd_inst_0 control_bd_inst_0_i
       (.i_clk(i_clk),
