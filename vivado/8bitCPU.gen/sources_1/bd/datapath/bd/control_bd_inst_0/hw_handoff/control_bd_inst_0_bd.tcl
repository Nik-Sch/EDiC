...
################################################################
# This is a generated script based on design: control_bd_inst_0
#
...
# source control_bd_inst_0_script.tcl
...
set design_name control_bd_inst_0
...
if { ${design_name} eq "" } {
   ...
   create_bd_design -bdsource /home/niklas/dev/8bitCpu/vivado/8bitCPU.srcs/sources_1/bd/control_bd/control_bd.bd $design_name
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net i_clk_0_1 [get_bd_ports i_clk] [get_bd_pins control_0/i_clk] [get_bd_pins instrDecode/clka]
