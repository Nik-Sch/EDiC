...
(* CORE_GENERATION_INFO = "control_bd_inst_0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=control_bd_inst_0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=3,numReposBlks=3,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=/home/niklas/dev/8bitCpu/vivado/8bitCPU.srcs/sources_1/bd/control_bd/control_bd.bd,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "control_bd_inst_0.hwdef" *) 
module control_bd_inst_0
  ...
  control_bd_inst_0_xlconstant_0_0 xlconstant_0
