...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set i_flagCarry [ create_bd_port -dir I i_flagCarry ]
  set i_flagNegative [ create_bd_port -dir I i_flagNegative ]
  set i_flagOverflow [ create_bd_port -dir I i_flagOverflow ]
  set i_flagZero [ create_bd_port -dir I i_flagZero ]
  set i_halt [ create_bd_port -dir I i_halt ]
  ...
  set o_ctrlInstrFinishedN [ create_bd_port -dir O o_ctrlInstrFinishedN ]
  set o_ctrlMemInstrImmToRamAddr [ create_bd_port -dir O o_ctrlMemInstrImmToRamAddr ]
  ...
  set o_ctrlMemPCFromImm [ create_bd_port -dir O o_ctrlMemPCFromImm ]
  set o_ctrlMemPCLoadN [ create_bd_port -dir O o_ctrlMemPCLoadN ]
  set o_ctrlMemPCNEn [ create_bd_port -dir O o_ctrlMemPCNEn ]
  set o_ctrlMemPCToRamN [ create_bd_port -dir O o_ctrlMemPCToRamN ]
  ...
  set o_ctrlReg0BusNOE [ create_bd_port -dir O o_ctrlReg0BusNOE ]
  set o_ctrlReg0NWE [ create_bd_port -dir O o_ctrlReg0NWE ]
  set o_ctrlReg1BusNOE [ create_bd_port -dir O o_ctrlReg1BusNOE ]
  ...
  connect_bd_net -net control_0_o_ctrlInstrFinishedN [get_bd_ports o_ctrlInstrFinishedN] [get_bd_pins control_0/o_ctrlInstrFinishedN]
  connect_bd_net -net control_0_o_ctrlMemInstrImmToRamAddr [get_bd_ports o_ctrlMemInstrImmToRamAddr] [get_bd_pins control_0/o_ctrlMemInstrImmToRamAddr]
  ...
  connect_bd_net -net control_0_o_ctrlMemPCFromImm [get_bd_ports o_ctrlMemPCFromImm] [get_bd_pins control_0/o_ctrlMemPCFromImm]
  connect_bd_net -net control_0_o_ctrlMemPCLoadN [get_bd_ports o_ctrlMemPCLoadN] [get_bd_pins control_0/o_ctrlMemPCLoadN]
  connect_bd_net -net control_0_o_ctrlMemPCNEn [get_bd_ports o_ctrlMemPCNEn] [get_bd_pins control_0/o_ctrlMemPCNEn]
  connect_bd_net -net control_0_o_ctrlMemPCToRamN [get_bd_ports o_ctrlMemPCToRamN] [get_bd_pins control_0/o_ctrlMemPCToRamN]
  ...
  connect_bd_net -net control_0_o_ctrlReg0BusNOE [get_bd_ports o_ctrlReg0BusNOE] [get_bd_pins control_0/o_ctrlReg0BusNOE]
  connect_bd_net -net control_0_o_ctrlReg0NWE [get_bd_ports o_ctrlReg0NWE] [get_bd_pins control_0/o_ctrlReg0NWE]
  connect_bd_net -net control_0_o_ctrlReg1BusNOE [get_bd_ports o_ctrlReg1BusNOE] [get_bd_pins control_0/o_ctrlReg1BusNOE]
  ...
  connect_bd_net -net i_flagCarry_0_1 [get_bd_ports i_flagCarry] [get_bd_pins control_0/i_flagCarry]
  connect_bd_net -net i_flagNegative_0_1 [get_bd_ports i_flagNegative] [get_bd_pins control_0/i_flagNegative]
  connect_bd_net -net i_flagOverflow_0_1 [get_bd_ports i_flagOverflow] [get_bd_pins control_0/i_flagOverflow]
  connect_bd_net -net i_flagZero_0_1 [get_bd_ports i_flagZero] [get_bd_pins control_0/i_flagZero]
  connect_bd_net -net i_halt_0_1 [get_bd_ports i_halt] [get_bd_pins control_0/i_halt]
  connect_bd_net -net i_instrCode_0_1 [get_bd_ports i_instrCode] [get_bd_pins control_0/i_instrCode]
  connect_bd_net -net i_nclk_1 [get_bd_ports i_nclk] [get_bd_pins control_0/i_nclk] [get_bd_pins instrDecode/clka]
