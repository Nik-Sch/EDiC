...
#
# EDiC-TTL.tcl: Tcl script for re-creating project 'EDiC-TTL'
#
# Generated by Vivado on Mon Sep 26 15:52:55 CEST 2022
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/xilinx_ips/as6c4008_55pcn_mem/as6c4008_55pcn_mem.xci"]"\
 "[file normalize "$origin_dir/xilinx_ips/uart_fifo_rx/uart_fifo_rx.xci"]"\
 "[file normalize "$origin_dir/xilinx_ips/uart_fifo_tx/uart_fifo_tx.xci"]"\
 "[file normalize "$origin_dir/xilinx_ips/clk_wiz_5Mhz/clk_wiz_5Mhz.xci"]"\
 "[file normalize "$origin_dir/xilinx_ips/microCodeRom/microCodeRom.xci"]"\
 "[file normalize "$origin_dir/xilinx_ips/instructionRom/instructionRom.xci"]"\
  ]
  foreach ifile $files {
...
set_property -name "webtalk.xsim_launch_sim" -value "242" -objects $obj
...
set file "$origin_dir/../memory_files/microCodeRom.coe"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
...
# Set 'sources_1' fileset file properties for local files
set file "as6c4008_55pcn_mem/as6c4008_55pcn_mem.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# Set 'sources_1' fileset file properties for local files
set file "uart_fifo_rx/uart_fifo_rx.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "uart_fifo_tx/uart_fifo_tx.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "clk_wiz_5Mhz/clk_wiz_5Mhz.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
...
# Set 'sources_1' fileset file properties for local files
set file "microCodeRom/microCodeRom.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
# Set 'sources_1' fileset file properties for local files
set file "instructionRom/instructionRom.xci"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
if { ![get_property "is_locked" $file_obj] } {
  set_property -name "generate_synth_checkpoint" -value "1" -objects $file_obj
...
set file "[file normalize "$origin_dir/_src/io_constraints.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/_src/io_constraints.xdc"
set file [file normalize $file]
...
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/_src/io_constraints.xdc"]" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/_src/io_constraints.xdc"]" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EDiC-TTL.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/EDiC-TTL.srcs/utils_1/imports/impl_1" -objects $obj
