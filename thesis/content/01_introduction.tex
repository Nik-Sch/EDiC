...
\Cref{cha:fpga} gives a short background to \gls{FPGA} and then covers all the important aspects of the \gls{FPGA} model which was created to verify the architecture.
